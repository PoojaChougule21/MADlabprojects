...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnTwo=(Button) findViewById(R.id.button11);
        btnTwo.setOnClickListener(this);
        btnThree=(Button) findViewById(R.id.button12);
        btnThree.setOnClickListener(this);
        btnFour=(Button) findViewById(R.id.button13);
        btnFour.setOnClickListener(this);
        btnFive=(Button) findViewById(R.id.button14);
        btnFive.setOnClickListener(this);
        btnSix=(Button) findViewById(R.id.button15);
        btnSix.setOnClickListener(this);
        btnSeven=(Button) findViewById(R.id.button16);
        btnSeven.setOnClickListener(this);
        btnEight=(Button) findViewById(R.id.button17);
        btnEight.setOnClickListener(this);
        btnNine=(Button) findViewById(R.id.button18);
        btnNine.setOnClickListener(this);
        btnZero=(Button) findViewById(R.id.button20);
        btnZero.setOnClickListener(this);
        btnStar=(Button) findViewById(R.id.button19);
        btnStar.setOnClickListener(this);
        btnHash=(Button) findViewById(R.id.button21);
        btnHash.setOnClickListener(this);
        btnCall =(Button) findViewById(R.id.button22);
        btnCall.setOnClickListener(this);
        btnSave=(Button) findViewById(R.id.button23);
        btnSave.setOnClickListener(this);
        btnDel=(Button) findViewById(R.id.button2);
        btnDel.setOnClickListener(this);
        txtPhonenumber=(EditText) findViewById(R.id.editTextTextPersonName);
